...
Source0  : https://download.gnome.org/sources/gnome-console/44/gnome-console-44.0.tar.xz
...
%prep
%setup -q -n gnome-console-44.0
cd %{_builddir}/gnome-console-44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679687783
