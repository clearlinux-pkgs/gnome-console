...
Version  : 45.0
Release  : 12
URL      : https://download.gnome.org/sources/gnome-console/45/gnome-console-45.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-console/45/gnome-console-45.0.tar.xz
...
%prep
%setup -q -n gnome-console-45.0
cd %{_builddir}/gnome-console-45.0
pushd ..
cp -a gnome-console-45.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695680514
