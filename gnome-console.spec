...
%prep
%setup -q -n gnome-console-42.2
cd %{_builddir}/gnome-console-42.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657817882
...
cp %{_builddir}/gnome-console-42.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-console/338650eb7a42dd9bc1f1c6961420f2633b24932d
