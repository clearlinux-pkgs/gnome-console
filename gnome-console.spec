...
Version  : 42.0
Release  : 2
URL      : https://download.gnome.org/sources/gnome-console/42/gnome-console-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-console/42/gnome-console-42.0.tar.xz
...
%prep
%setup -q -n gnome-console-42.0
cd %{_builddir}/gnome-console-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657744038
...
cp %{_builddir}/gnome-console-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-console/338650eb7a42dd9bc1f1c6961420f2633b24932d
