...
Version  : 43.0
Release  : 8
URL      : https://download.gnome.org/sources/gnome-console/43/gnome-console-43.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-console/43/gnome-console-43.0.tar.xz
...
%prep
%setup -q -n gnome-console-43.0
cd %{_builddir}/gnome-console-43.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664147769
