...
Version  : 43.rc
Release  : 6
URL      : https://download.gnome.org/sources/gnome-console/43/gnome-console-43.rc.tar.xz
Source0  : https://download.gnome.org/sources/gnome-console/43/gnome-console-43.rc.tar.xz
...
%prep
%setup -q -n gnome-console-43.rc
cd %{_builddir}/gnome-console-43.rc
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664029141
